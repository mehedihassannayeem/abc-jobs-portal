            ...
            <section class="home-section">
                <div class="container-fluid">
                    ...
                    <%@ include file="./navbar.jsp" %>
                        ...
                        <form action="${pageContext.request.contextPath}/elearn-create-course" method="post" class="mt-5">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-4 my-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ecTitle" name="ecourse_title"
                                ...
                                <div class="col-12 col-md-4 my-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ecHours" name="hours_required"
                                ...
                                <div class="col-12 col-md-4 my-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ecVideos" name="videos"
                            ...
                            <div class="row">
                                <div class="col-12 col-md-4 my-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ecQuizzes" name="quizzes"
                                ...
                                <div class="col-12 col-md-4 my-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ecNotes" name="notes"
                                ...
                                <div class="col-12 col-md-4 my-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ecCertificate" name="certificate"
