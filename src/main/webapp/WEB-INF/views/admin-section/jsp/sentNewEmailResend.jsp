            ...
            <section class="home-section">
                <div class="container-fluid">
                    ...
                    <%@ include file="./navbar.jsp" %>
                        ...
                        <form action="sent-emails-again" method="post" class="my-5">
                        	<input type="hidden" value="${resendEmails.bulk_email_serial }" name="bulk_email_serial" />
                            <div class="row">
                                <div class="col-12 col-md-4 my-3">
                                    <div class="mb-3">
                                        <label for="adminId" class="form-label">Admin Name</label><br>                                       
                                        <select name="admin_name" id="adminId" required>
                                        <option value="${resendEmails.admin_name }" class="text-white fs-2 bg-warning" selected>${resendEmails.admin_name }</option>
                                ...
                                <div class="col-12 col-md-4 my-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" id="invEmail" name="invited_email_address_1"
                                            placeholder="invite@gmail.com" value="${resendEmails.invited_email_address_1 }" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4 my-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" id="invEmail" name="invited_email_address_2"
                                            placeholder="invite@gmail.com" value="${resendEmails.invited_email_address_2 }" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            	<div class="col-12 col-md-4 my-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" id="invEmail" name="invited_email_address_3"
                                            placeholder="invite@gmail.com" value="${resendEmails.invited_email_address_3 }" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4 my-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" id="invEmail" name="invited_email_address_4"
                                            placeholder="invite@gmail.com" value="${resendEmails.invited_email_address_4 }" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4 my-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" id="invEmail" name="invited_email_address_5"
                                            placeholder="invite@gmail.com" value="${resendEmails.invited_email_address_5 }" required>
                                    </div>
                                </div>
                            </div>
                            <button type="submit"
