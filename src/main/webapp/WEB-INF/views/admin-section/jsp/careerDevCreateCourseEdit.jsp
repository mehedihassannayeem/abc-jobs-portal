                ...
                <div class="container-fluid">
                    ...
                    <%@ include file="./navbar.jsp" %>
                        ...
                        <form action="${pageContext.request.contextPath}/create-career-dev-course" method="post" class="mt-5">
                        	<input type="hidden" name="career_dev_con_id" value="${careerDevCourse.career_dev_con_id }" />
                            <div class="row">
                                <div class="col-12 col-md-4 my-3">
                                    <div class="mb-3">
                                        <label for="adminId" class="form-label">Admin Name</label><br>
                                        <select name="admin_name" id="adminId" required>
                                        	<option value="${careerDevCourse.admin_name }" class="text-white fs-2 bg-warning" selected>${careerDevCourse.admin_name }</option>
                                ...
                                <div class="col-12 col-md-4 my-3">
                                    <div class="mb-3">
                                        ...
                                        <select name="course_shift" id="courseShift" required>
                                        	<option value="${careerDevCourse.course_shift }" class="text-white fs-2 bg-warning" selected>${careerDevCourse.course_shift }</option>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-4 my-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="cdcTitle" name="course_title" value="${careerDevCourse.course_title }"
                                ...
                                <div class="col-12 col-md-4 my-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="cdcDate" name="course_date" value="${careerDevCourse.course_date }"
                                ...
                                <div class="col-12 col-md-4 my-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="cdcSchedule" name="course_schedule" value="${careerDevCourse.course_schedule }"
