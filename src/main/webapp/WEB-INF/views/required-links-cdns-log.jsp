<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ page isELIgnored="false" %>
			...
			<c:if test="${loggedUserProfile.profile_image != null }">
				<link rel="icon" type="jpg/gif/png" href="<c:url value="/resources/user-contents/${loggedUserProfile.profile_image }" />" >
			</c:if>
            ...
            <link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/globar-style.css" />">
            <script type="text/javascript" src="<c:url value="/resources/js/global-script.js" />" ></script>
            
            
            <!-- dashboard navbar css and js files -->
            <link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/dashNavbar.css" />">
            <script type="text/javascript" src="<c:url value="/resources/js/dashNavbar.js" />" ></script>       
 			...
 			<title>
            <c:out value="${loggedUserProfile.up_userPersonalInfo.fullname }">ABC Jobs Portal</c:out>            	            
            </title>   
