...
public class ResetPasswordInvalidOtpInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		String userOtpInput = request.getParameter("resOtpCon");
		...
		} else if (!session.getAttribute("userResetAuthOtp").equals(userOtpInput)) {
